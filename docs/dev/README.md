...
1. Satu modul adalah **release unit mandiri**: API, UI artifact, database, migration, kontrak, dan image Docker.
2. Modul dapat di-install, di-enable, di-upgrade, di-disable, dan di-uninstall secara aman.
...
5. Customisasi tidak dilakukan dengan fork CoreERP. Gunakan konfigurasi, integration connector, atau addon module.
...
| [02-module-standard.md](02-module-standard.md) | Bentuk release unit, manifest, database ownership, dan lifecycle modul |
...
| [06-worktree-target.md](06-worktree-target.md) | Kondisi repo sekarang dan target struktur implementasinya |
| [07-reporting-and-replicas.md](07-reporting-and-replicas.md) | Read replica per module, reporting projection lintas module, dan consistency policy |
...
| Module | Kemampuan bisnis yang bisa dipasang, misalnya POS atau Booking. |
| Addon | Module tambahan, biasanya integration atau kebutuhan khusus customer. |
...
| On-prem perpetual | Deployment Compose di server customer dengan module yang dibeli saja, state instalasi lokal, lisensi perpetual bertanda tangan, dan update manual. Server tetap dapat online untuk pengguna customer tanpa harus tersambung ke vendor. |
