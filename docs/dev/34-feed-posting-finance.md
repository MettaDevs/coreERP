...
- [admin.erp](31-admin-erp-control-plane.md#kesehatan-feed-posting-finance) — ringkasan jumlah per status, `pending` tertua, pull terakhir, dan push terakhir yang diterima pembaca, tiap server klien (`finance-postings:summary`).
