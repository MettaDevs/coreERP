...
| [01-prd.md](01-prd.md) | Rencana kerjanya: 77 task ukuran satu pull request dalam delapan fase, lengkap dengan berkas yang disentuh, syarat selesai, rencana mundur, dan ukuran keberhasilan | Saat mengambil task berikutnya |
...
| Fase | Task | Selesai |
| --- | --- | --- |
| 0 — prasyarat: CI hijau, aturan kerja, kunci retensi | F0-01 sampai F0-04 | F0-01 selesai |
...
Total 77 task. Fase 0 membereskan yang sudah menghalangi sebelum proyek dimulai: pemeriksaan otomatis
