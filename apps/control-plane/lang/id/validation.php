...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut berisi pesan standar yang digunakan oleh kelas validasi.
    | Beberapa aturan memiliki beberapa versi seperti aturan ukuran.
    | Anda bebas memodifikasi setiap pesan di sini sesuai kebutuhan aplikasi.
    |
    */
    ...
    'missing_with' => ':attribute tidak boleh ada jika terdapat :values.',
    'missing_with_all' => ':attribute tidak boleh ada jika terdapat seluruh :values.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute yang diberikan telah muncul dalam kebocoran data. Silakan pilih kata sandi yang berbeda.',
    ],
    ...
    'required_with_all' => ':attribute wajib diisi jika terdapat seluruh :values.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Baris Kustom Atribut Validasi
    |--------------------------------------------------------------------------
    |
    | Baris berikut digunakan untuk menukar placeholder atribut dengan sesuatu
    | yang lebih mudah dibaca seperti "Alamat Email" daripada "email".
    |
    */
