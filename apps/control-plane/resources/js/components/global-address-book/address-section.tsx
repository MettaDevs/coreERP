                    ...
                    <CardContent className="pt-4">
                        {addresses.length === 0 ? (
                            <Empty className="py-8">
                                ...
                                <EmptyHeader>
                                    <EmptyTitle>Belum ada alamat terdaftar</EmptyTitle>
                                    <EmptyDescription>
                                        Tambahkan alamat kantor, pabrik, gudang, atau lokasi pengiriman pihak ini.
                                    </EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                        ) : (
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-muted/40">
                                            ...
                                            <TableHead className="w-48">Nama / Keterangan</TableHead>
                                            <TableHead>Alamat Lengkap</TableHead>
                                            <TableHead className="w-40">Peruntukan</TableHead>
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="py-2.5 text-xs">
                                                        ...
                                                        <span className="block text-[11px] text-muted-foreground">
                                                            {[addr.building_complement, addr.district, addr.city, addr.state, addr.postal_code, addr.country]
                                                                .filter(Boolean)
                                                                .join(', ')}
                                                        </span>
                                                    </TableCell>
