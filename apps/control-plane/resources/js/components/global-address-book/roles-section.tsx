            ...
            {isExpanded && (
                ...
                {roles.length === 0 ? (
                    <Empty className="py-6">
                        ...
                        <EmptyHeader>
                            <EmptyTitle>Belum ada peran terdaftar</EmptyTitle>
                            <EmptyDescription>
                                Peran bisnis pihak ini (Customer, Vendor, Prospect) akan terdaftar otomatis saat dipakai di modul terkait.
                            </EmptyDescription>
                        </EmptyHeader>
                    </Empty>
                ) : (
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-muted/40">
                                    ...
                                    <TableHead>Nomor Akun (Account)</TableHead>
                                    <TableHead>Peran Bisnis (Role)</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {roles.map((r, idx) => (
