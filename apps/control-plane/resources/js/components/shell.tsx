...
export default function Shell({
    ...
    return (
        <AppShell>
            <AppSidebar />
            <SidebarInset className="h-svh min-w-0 overflow-hidden bg-muted/30 py-2 pr-2 pl-0">
                {/*
                ...
                */}
                ...
                >
                    <div className="flex min-h-[calc(100svh-1rem)] w-full min-w-0 flex-col rounded-2xl border bg-background shadow-sm">
                        ...
                        <div className="min-w-0 flex-1 space-y-6 rounded-b-2xl bg-muted/30 px-6 py-6">
