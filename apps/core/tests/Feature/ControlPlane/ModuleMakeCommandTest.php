...
class ModuleMakeCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->app->setBasePath($this->akarSementara.'/apps/core');
    }
    ...
    public function test_package_module_didaftarkan_pada_composer_core(): void
    {
        ...
        $isi = (string) file_get_contents($this->akarSementara.'/apps/core/composer.json');
    ...
    public function test_id_yang_tidak_sah_ditolak_tanpa_meninggalkan_jejak(string $id): void
    {
        ...
        $composerSebelum = (string) file_get_contents($this->akarSementara.'/apps/core/composer.json');
        ...
        $this->assertSame($composerSebelum, (string) file_get_contents($this->akarSementara.'/apps/core/composer.json'));
    }
    ...
    private function siapkanRepoTiruan(): void
    {
        ...
        $this->tulis($this->akarSementara.'/apps/core/composer.json', implode("\n", [
            '{',
            '    "name": "coreerp/core",',
            '    "require": {',
            '        "php": "^8.4",',
