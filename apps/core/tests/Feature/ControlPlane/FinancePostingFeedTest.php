...
class FinancePostingFeedTest extends TestCase
{
    ...
    /**
     * Pemeriksa kecil atas skema OpenAPI yang ditulis tangan: kunci wajib, kunci terlarang, tipe,
     * enum, dan pola. Tanpa ini payload dan kontraknya dapat menyimpang tanpa satu test pun merah.
     */
    private function assertCocokSkema(mixed $data, string $skema): void
    {
        $spec = Yaml::parseFile(base_path('contracts/openapi-internal.yaml'));
