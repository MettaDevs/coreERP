...
final class ModuleDisableCommand extends Command
{
    ...
    public function handle(DisableModule $action): int
    {
        try {
        ...
        $this->info(sprintf('Module "%s" dinonaktifkan untuk tenant %s. Datanya tidak disentuh.', $installation->module_id, $installation->tenant_id));
