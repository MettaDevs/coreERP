...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tr_permintaan_pengadaan_aset', function (Blueprint $table): void {
            ...
            $table->ulid('requesting_org_unit_id')->index();
            $table->string('requester_user_id', 64);
            ...
            $table->index(['tenant_id', 'legal_entity_id', 'requesting_org_unit_id', 'status']);
        });
        Schema::create('tr_permintaan_pengadaan_aset_details', function (Blueprint $table): void {
            ...
            $table->ulid('planning_detail_id')->nullable();
            ...
            $table->timestamps();
            $table->unique(['tenant_id', 'request_id', 'line_number']);
            $table->foreign(['tenant_id', 'request_id'])->references(['tenant_id', 'id'])->on('tr_permintaan_pengadaan_aset')->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('tr_permintaan_pengadaan_aset_details');
        Schema::dropIfExists('tr_permintaan_pengadaan_aset');
    }
};
