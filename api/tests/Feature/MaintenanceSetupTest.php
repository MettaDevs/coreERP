...
class MaintenanceSetupTest extends TestCase
{
    ...
    public function test_setup_maintenance_menyimpan_job_type_varian_relasi_dan_checklist(): void
    {
        ...
        $this->withContext(['management-aset.maintenance-checklist-templates.read', 'management-aset.maintenance-checklist-templates.update'])
            ->putJson('/api/v1/maintenance-checklist-templates/'.$template.'/lines', ['lines' => [
                ...
                ['line_number' => 2, 'type' => 'measurement', 'nama' => 'Tegangan', 'unit' => 'V', 'wajib' => true, 'instruksi' => 'Ukur pada terminal utama.'],
            ]])->assertOk()->assertJsonCount(2, 'data');
        ...
        $this->assertDatabaseHas('m_maintenance_checklist_template_line', [
            ...
            'instruksi' => 'Ukur pada terminal utama.', 'wajib' => true,
        ]);
    ...
    public function test_aturan_validasi_status_disemai_dan_dapat_diubah_tenant(): void
    {
        ...
        // Matriks lengkap disemai supaya layar pengaturan tidak berlubang, tetapi hanya
        // checklist saat selesai yang aktif secara bawaan.
